...
const titles: Record<CalloutVariant, string> = {
  ...
  warn: "Warnpanel",
  tip: "Hinweispanel",
  danger: "Wichtig-Panel",
};

/**
 * Panel-Darstellung mit Icon links statt Textlabel.
 */
export function CalloutView({ node }: NodeViewProps) {
  ...
  return (
    <NodeViewWrapper
      as="aside"
      className={`editor-callout editor-callout-${variant}`}
      data-callout={variant}
      data-drag-handle
    >
      <span className="editor-callout-icon" contentEditable={false} title={titles[variant]} aria-hidden>
        <CalloutIcon variant={variant} />
      </span>
      <NodeViewContent className="editor-callout-body" as="div" />
    </NodeViewWrapper>
  );
}
