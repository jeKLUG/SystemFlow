...
- **marketing_lists** / **marketing_leads** / **marketing_templates** / **marketing_sends** – Akquise (Staff `/marketing`): eigene Leads getrennt von `customers`, Textbausteine Erstmail/Erinnerung, Versandprotokoll. Abmelde-Token am Lead (`unsubToken`).
