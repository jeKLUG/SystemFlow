...
Der Windows-/Linux-Monitoring-Agent liegt unter `apps/agent`. Binaries in den Konto-Einstellungen hochladen; Install-Skripte (PowerShell/Bash) von dort kopieren. CI-Build: `.github/workflows/monitoring-agent.yml`.
